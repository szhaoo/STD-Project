...
(function(window, angular, undefined) {
  ...
  var urlBase = "http://serenazhao.tk/api";
 ...
 */
  module.factory(
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/Clinics/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Clinic.offers.findById() instead.
            "prototype$__findById__offers": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Clinics/:id/offers/:fk",
              method: "GET",
            },

            // INTERNAL. Use Clinic.offers.destroyById() instead.
            ...
            // INTERNAL. Use Clinic.offers.updateById() instead.
            ...
            // INTERNAL. Use Clinic.offers() instead.
            "prototype$__get__offers": {
              isArray: true,
              url: urlBase + "/Clinics/:id/offers",
              method: "GET",
            },

            // INTERNAL. Use Clinic.offers.create() instead.
            "prototype$__create__offers": {
              url: urlBase + "/Clinics/:id/offers",
              method: "POST",
            },

            // INTERNAL. Use Clinic.offers.destroyAll() instead.
            "prototype$__delete__offers": {
              url: urlBase + "/Clinics/:id/offers",
              method: "DELETE",
            },

            // INTERNAL. Use Clinic.offers.count() instead.
            "prototype$__count__offers": {
              url: urlBase + "/Clinics/:id/offers/count",
              method: "GET",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.Clinic#patchOrCreate
             * @methodOf lbServices.Clinic
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Clinic#replaceOrCreate
             * @methodOf lbServices.Clinic
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/Clinics/replaceOrCreate",
              method: "POST",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.Clinic#replaceById
             * @methodOf lbServices.Clinic
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/Clinics/:id/replace",
              method: "POST",
            },
            ...
            /**
             * @ngdoc method
             * @name lbServices.Clinic#prototype$patchAttributes
             * @methodOf lbServices.Clinic
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Clinic#updateAttributes
             * @methodOf lbServices.Clinic
             *
             * @description
             *
    ...
    /**
     * @ngdoc object
     * @name lbServices.Clinic.offers
     * @header lbServices.Clinic.offers
     * @object
     * @description
     *
     * The object `Clinic.offers` groups methods
     * manipulating `Service` instances related to `Clinic`.
     *
     * Call {@link lbServices.Clinic#offers Clinic.offers()}
     ...
     */
        ...
        R.offers = function() {
          ...
          var action = TargetResource["::get::Clinic::offers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clinic.offers#count
             * @methodOf lbServices.Clinic.offers
             *
             * @description
             *
             * Counts offers of Clinic.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.offers.count = function() {
          var TargetResource = $injector.get("Service");
          var action = TargetResource["::count::Clinic::offers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clinic.offers#create
             * @methodOf lbServices.Clinic.offers
             *
             * @description
             *
        ...
        R.offers.create = function() {
          var TargetResource = $injector.get("Service");
          var action = TargetResource["::create::Clinic::offers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clinic.offers#createMany
             * @methodOf lbServices.Clinic.offers
             *
             * @description
             *
        ...
        R.offers.createMany = function() {
          var TargetResource = $injector.get("Service");
          var action = TargetResource["::createMany::Clinic::offers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clinic.offers#destroyAll
             * @methodOf lbServices.Clinic.offers
             *
             * @description
             *
        ...
        R.offers.destroyAll = function() {
          var TargetResource = $injector.get("Service");
          var action = TargetResource["::delete::Clinic::offers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clinic.offers#destroyById
             * @methodOf lbServices.Clinic.offers
             *
             * @description
             *
        ...
        R.offers.destroyById = function() {
          var TargetResource = $injector.get("Service");
          var action = TargetResource["::destroyById::Clinic::offers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clinic.offers#findById
             * @methodOf lbServices.Clinic.offers
             *
             * @description
             *
        ...
        R.offers.findById = function() {
          var TargetResource = $injector.get("Service");
          var action = TargetResource["::findById::Clinic::offers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Clinic.offers#updateById
             * @methodOf lbServices.Clinic.offers
             *
             * @description
             *
        ...
        R.offers.updateById = function() {
          var TargetResource = $injector.get("Service");
          var action = TargetResource["::updateById::Clinic::offers"];
          return action.apply(R, arguments);
        };
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/services/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Clinic.offers.create() instead.
            "::create::Clinic::offers": {
              url: urlBase + "/Clinics/:id/offers",
              method: "POST",
            },

            // INTERNAL. Use Clinic.offers.createMany() instead.
            "::createMany::Clinic::offers": {
              isArray: true,
              url: urlBase + "/Clinics/:id/offers",
              method: "POST",
            },
